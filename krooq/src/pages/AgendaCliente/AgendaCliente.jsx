...
function AgendaCliente() {
  ...
  return (
    <section
      className="container-agenda-cliente"
      style={{ backgroundImage: `url(${AgendaBG})` }}
    >
      <div
        className="overlay-voltar-agenda-cliente"
        onClick={() => navigate("/CentralCliente")}
      />
      ...
      <div className="lado-direito-agenda-cliente">
        <section className="painel-eventos-agenda-cliente">
          <SemanaAgenda
            dataSelecionada={dataSelecionada}
            setDataSelecionada={setDataSelecionada}
          />

          <div className="topo-eventos-agenda-cliente">
            <h2>Compromissos</h2>

            <button
              className="botao-adicionar-agenda-cliente"
          ...
          <div className="lista-eventos-agenda-cliente">
            {eventos
              .filter(
                (evento) =>
      ...
      <img
        className="logo-krooq-agenda-cliente"
        src={LogoKrooq}
        alt="Logo Krooq"
      />
    </section>
